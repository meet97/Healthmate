                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item"><a href="logoutServ" class="menu__link"><span class="menu__helper">Contact Us</span></a></li>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center">
                    <div class="search-box">
                        ...
                        <form action="registration_doctor" id="myform" class="loginForm">
                            <div class="input-group">
                                ...
                                <input style="margin: 20px 2px;" name="emailid" id="emailid" type="text" class="form-control" pattern="\S+@\S+" title="EmailId" required placeholder="Email Id">

                                <input style="margin: 20px 2px;" name="password" id="password" required pattern="^.{8,15}$" type="password" class="form-control" title="Password Must be between 8 to 15 letters" placeholder="Password">					

                                <input style="margin: 20px 2px;" name="confirmpass" id="confirmpass" required pattern="^.{8,15}$" type="password" class="form-control" title="Password Must be between 8 to 15 letters" placeholder="Confirm Password">					
