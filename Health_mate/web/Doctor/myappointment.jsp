<%-- 
    ...
    Created on : Feb 26, 2018, 11:29:06 AM
    Author     : admin
--%>
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="myappointment.jsp" class="menu__link"><span class="menu__helper">Appointments</span></a></li>
