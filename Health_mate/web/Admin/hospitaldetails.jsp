...
<%@page import="modal.Locationdetails"%>
...
<html>
    ...
    <body>
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="hospitaldetails.jsp" class="menu__link"><span class="menu__helper">Hospital Details</span></a></li>
        ...
        <br>
    <center>
        <h6><font size="70">All Hospital Details</font></h6>
        <br><br>
        <table>
            <tr>
                <th>Hospital Name</th>
            ...
            try {
                ...
                for(int i=0;i<al.size();i++)
                {
                    ...
                    out.println("<td>"+hd.getMobile2() + "</td>");
                    out.println("<td>"+hd.getEmailid1()+ "</td>");
                    ...
                    {
                        out.println("<td>"+lod.getAddress()+ "</td>");
                        out.println("<td>"+lod.getCity()+ "</td>");
                        out.println("<td>"+lod.getState() + "</td>");
                        out.println("<td>"+lod.getCountry() + "</td>");
                        out.println("<td>"+lod.getPincode() + "</td>");
                    }
                    out.println("</tr>");
                }
                tr.commit();
