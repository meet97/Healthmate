...
<html>
    ...
    <body onload="CheckNotification()">
        ...
        <br><br><br><br>
        <div class="container">
            <form class="form-horizontal" action="update_profile">
                <label class="control-label col-sm-3" for="email">First Name:</label>
                <div class="col-sm-3">
                    <input type="text" pattern="[a-zA-Z]+" required class="form-control" id="fname" placeholder="Enter First Name" name="fname">
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwd">Middle Name:</label>
                    <div class="col-sm-3">          
                        <input type="text" pattern="[a-zA-Z]+" required class="form-control" id="mname" placeholder="Enter Middle Name" name="mname">
                    </div>
                </div><br>
                <label class="control-label col-sm-3" for="pwd">Last Name:</label>
                <div class="col-sm-3">          
                    <input type="text" pattern="[a-zA-Z]+" required class="form-control" id="lname" placeholder="Enter Last Name" name="lname">
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwd">Mobile:</label>
                    <div class="col-sm-3">          
                        <input type="text" pattern="[1-9]{1}[0-9]{9}" required class="form-control" id="mobile" placeholder="Enter Mobile" name="mobile">
                    </div>
                </div><br>
                <label class="control-label col-sm-3" for="pwd">Email ID:</label>
                <div class="col-sm-3">          
                    <input type="text" pattern="\S+@\S+" required class="form-control" id="emailid" placeholder="Enter Email-id" name="emailid">
                </div>
                <div class="form-group">
                ...
                <div class="col-sm-3">          
                    <input type="text" pattern="[a-zA-Z]+" required class="form-control" id="city" placeholder="Enter your city" name="city">
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pwd">State:</label>
                    <div class="col-sm-3">          
                        <select pattern="[a-zA-Z]+" class="form-control" id="state" placeholder="Enter your state" name="state">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">          
                        <input type="text" pattern="[0-9]{6}" class="form-control" id="pincode" placeholder="Enter your pincode" name="pincode">
                    </div>
                </div>
                <br>       
