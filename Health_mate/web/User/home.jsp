<%-- 
    Document   : home
    Created on : Jan 21, 2018, 7:12:11 PM
    Author     : sonav
--%>
        ...
        <div class="bottom">
            <div class="container">
                <div class="bottom-top">
                    ...
                    <p style="color: yellow;">Doctor appointment timing vary with their schedule. HealthMate provide facility to book doctor <a href="myappointment.jsp" style="color: black;">APPOINTMENT</a> at any time.</p>
                    <div class="opening_hours">
                        <ul class="times">
                            <h4>Opening <span class="opening">Hours</span></h4>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Monday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Tuesday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Wednesday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Thrusday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Friday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Saturday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                            <li><i class="glyphicon glyphicon-time"> </i><span class="week">Sunday</span><div class="hours">24 hrs</div>  <div class="clearfix"></div></li>
                        </ul>
                    </div>
                </div>
            </div>
