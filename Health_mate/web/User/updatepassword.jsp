        ...
        <div>
            <form class="form-horizontal" action="update_password">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required placeholder="Enter old password" name="oldpass">
                    </div>
                </div><br>
                <div class="form-group">
                    <label class="control-label col-sm-5" for="pwd">New Password:</label>
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required pattern="^.{8,15}$" id="password" placeholder="Enter New password" name="newpass">
                    </div>
                </div><br>
                <div class="form-group">
                    <label class="control-label col-sm-5" for="pwd">Confirm Password:</label>
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required pattern="^.{8,15}$" id="confirmpass" placeholder="Enter Confirm password" name="confirmpass">
                    </div>
                </div><br>
                <div class="form-group">        
