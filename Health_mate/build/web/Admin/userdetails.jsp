...
<html>
    ...
    <body onload="CheckNotification()">
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        <li class="menu__item menu__item--current"><a href="userdetails.jsp" class="menu__link"><span class="menu__helper">User Details</span></a></li>
                                        <li class="menu__item"><a href="doctordetails.jsp" class="menu__link"><span class="menu__helper">Doctor Details</span></a></li>
        ...
        <br>
    <center>
        <h6><font size="80">All User Details</font></h6>
        <br><br>
        <table>
            <tr>
                <th>User Id</th>
            ...
            try {
                ...
                Criteria cr = se.createCriteria(Userdetails.class);
            
                ArrayList<Userdetails> al = (ArrayList<Userdetails>)cr.list();
                ...
                for(int i=0;i<al.size();i++)
                {
                    ...
                    Logindetails ld = ud.getLoginId();
                
                    out.println("<tr>");
                    out.println("<td>"+ud.getUserId() + "</td>");
                    out.println("<td>"+ud.getFirstname()+ "</td>");
                    out.println("<td>"+ud.getMiddlename()+ "</td>");
                    out.println("<td>"+ud.getLastname()+ "</td>");
                    out.println("<td>"+ud.getMobile()+ "</td>");
                    out.println("<td>"+ld.getEmailid()+ "</td>");
                
                    if(ld.getFlag())
                    {
                        out.println("<td><a class='kepybutton kepydisabled'>Activate</a><a href='deactivate?path=userdetails.jsp&emailid="+ld.getEmailid() +"' class='kepybutton kepyredbutton'>Deactivate</a></td>");
                    }
                    else
                    {
                        out.println("<td><a href='activate?path=userdetails.jsp&emailid="+ld.getEmailid()+"' class='kepybutton'>Activate</a><a class='kepybutton kepyredbutton kepydisabled'>Deactivate</a></td>");
                    }
                    out.println("</tr>");
                }
                tr.commit();
