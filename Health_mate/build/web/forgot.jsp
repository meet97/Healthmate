<%-- 
    Document   : forgot
    Created on : Jan 21, 2018, 9:51:11 PM
    Author     : sonav
--%>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center">
                    <div class="search-box">
                        <div class="caption">
                            <h3 style="font-size: 250%;">Reset Password</h3>
                            <br><br>
                        </div>
                        <form action="forgot_password" class="loginForm">
                            <div class="input-group">
                                <input type="text" id="emailid" name="emailid" class="form-control" required placeholder="Email Id">
