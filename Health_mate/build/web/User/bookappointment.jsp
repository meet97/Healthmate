            ...
            <table>
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="state" id="state_id" onchange="GetCity()">    
                ...
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="city" id="city_id" onchange="GetArea()">   
                                <option>Select</option>
                            </select>
                        </td>
                    </tr>
                ...
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="area" id="area_id" onchange="GetHospital()">   
                                <option>Select</option>
                            </select>
                        </td>
                    </tr>
                ...
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="hospital" id="hospital_id" onchange="GetDoctor()">
                                <option>Select</option>
                            </select>
                        </td>
                    </tr>
                ...
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="doctor" id="doctor_id" onchange="GetDate()">  
                                <option>Select</option>
                            </select>
                        </td>
                    </tr>
                ...
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <select name="date" id="date_id" onchange="GetTime()">  
                                <option>Select</option>
                            </select>
                        </td>
                    </tr>
