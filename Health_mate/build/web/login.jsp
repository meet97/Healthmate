<%-- 
    Document   : login
    Created on : Jan 21, 2018, 10:22:44 AM
    Author     : sonav
--%>
...
<html>
    ...
    <body onload="CheckNotification()">
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="login.jsp" class="menu__link"><span class="menu__helper">Login</span></a></li>
                                        <li class="menu__item"><a href="register.jsp" class="menu__link"><span class="menu__helper">Signup</span></a></li>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4 text-center">
                    <div class="search-box">
                        <div class="caption">
                            <h3 style="font-size: 250%;">Login Here</h3>
                            <br><br>
                        </div>
                        <form action="login" class="loginForm">
                            <div class="input-group">
                                <input style="margin: 20px 2px;" name="emailid" type="text" class="form-control" pattern="\S+@\S+" title="EmailId" required placeholder="Email Id">

                                <input style="margin: 20px 2px;" name="password" required pattern="^.{8,15}$" type="password" class="form-control" title="Password Must be between 8 to 15 letters" placeholder="Password">

                                <input style="background-color: #4CAF50;border: none;color: white;padding: 1px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 20px 2px;cursor: pointer;" type="submit" id="submit" class="form-control" value="Submit">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div style="text-align: center;">
            <h3 style="font-size: 125%;">Forgot password? </h3>
            <a href="forgot.jsp" style="color: #2afc46;"><button style="background-color: #4CAF50;border: none;color: white;padding: 8px 32px;text-decoration: none;display: inline-block;font-size: 16px;margin: 20px 2px;cursor: pointer;">Click Here</button></a>
        </div>
        <br><br><br>
