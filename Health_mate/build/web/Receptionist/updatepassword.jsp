                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item"><a href="profile.jsp" class="menu__link"><span class="menu__helper">My Profile</span></a></li>
                                        <li class="menu__item menu__item--current"><a href="updatepassword.jsp" class="menu__link"><span class="menu__helper">Update Password</span></a></li>
                                        <li class="menu__item"><a href="contact.html" class="menu__link"><span class="menu__helper">Contact Us</span></a></li>
                                        <li class="menu__item"><a href="logoutServ" class="menu__link"><span class="menu__helper">Logout</span></a>
                                        </li>
