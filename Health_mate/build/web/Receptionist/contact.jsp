                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                   <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="contact.jsp" class="menu__link"><span class="menu__helper">Contact Us</span></a></li>
        ...
        <div class="contact-top">
            <div class="container">
                <div class="contact-text">
                    <div class="con-text">
                        <p><a href="mailto:keyul.kepy@gmail.com"> keyul.kepy@gmail.com</a></p>
                        <p> +91 88 662 58602</p>
                    ...
                    <form method="GET" action="hello">
                        <div class="left_form">
                            <div>
                                ...
                                <span><input name="name" id="name" required type="text" class="textbox"></span>
                            </div>
                            <div>
                                <span><label>E-MAIL</label></span>
                                <span><input name="email" id="email" required type="text" class="textbox"></span>
                            </div>
                            <div>
                                <span><label>Subject</label></span>
                                <span><input name="subject" id="subject" required type="text" class="textbox"></span>
                            </div>
                        </div>
                        <div class="right_form">
                            <span><label>Message</label></span>
                            <span><textarea required id="user_message" required name="user_message"> </textarea></span>
                        </div>
                        <div class="right_form">
