...
<%@page import="modal.Receptionistdetails"%>
    ...
    <body>
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="updateappointment.jsp" class="menu__link"><span class="menu__helper">Appointments</span></a></li>
        ...
        <table>
            ...
            try {
                ...
                cr = se.createCriteria(Receptionistdetails.class);
                cr.add(Restrictions.eq("loginId", ld));
                ArrayList<Receptionistdetails> all = (ArrayList<Receptionistdetails>)cr.list();
                Receptionistdetails rd = all.get(0);
                Doctordetails dd = rd.getDoctorId();
                
                Date d = new Date();
                
                cr = se.createCriteria(Appointmentdetails.class);
                cr.add(Restrictions.eq("doctorId", dd));
                cr.add(Restrictions.eq("date", d));
                cr.addOrder(Order.asc("time"));
                ArrayList<Appointmentdetails> al_appointment = (ArrayList<Appointmentdetails>)cr.list();
                
                for (int i = 0; i < al_appointment.size(); i++)
                {
                    Appointmentdetails ad = al_appointment.get(i);
                    Logindetails ad_ld = ad.getLoginId();
                    
                    cr = se.createCriteria(Userdetails.class);
                    cr.add(Restrictions.eq("loginId", ad_ld));
                    ArrayList<Userdetails> al_user = (ArrayList<Userdetails>)cr.list();
                    Userdetails ud = al_user.get(0);
                    ...
                    if(ad.getFlag())
                    {
                        ...
                        out.println("<td><a href='receptionist_cancel_appointment?appointmentId="+ad.getAppointmentId()+"' class='kepybutton'>Cancel Appointment</a></td>");
                        out.println("</tr>");
                    }
                }
