<%-- 
    ...
    Created on : Feb 16, 2018, 6:17:15 PM
    Author     : admin
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/kepy_appointment.js"></script>
    ...
    <body onload="CheckNotification()">
                            ...
                            <div class="top-menu">
                                <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item menu__item--current"><a href="bookappointment.jsp" class="menu__link"><span class="menu__helper">Book Appointment</span></a></li>
        ...
        <form action="receptionist_book_appointment">
            <table>
                <div>
                    <tr>
                        <td>First Name</td> 
                        <td>:</td>
                        <td>
                            <input type="text" name="fname" id="fname" required pattern="[a-zA-Z]+"/>
                        </td>
                    </tr>
                </div>
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="lname" id="lname" required pattern="[a-zA-Z]+"/>
                        </td>
                    </tr>
                </div>
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="email" id="email" required pattern="\S+@\S+"/>
                        </td>
                    </tr>
                </div>
                <div>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="text" name="mobile" id="mobile" pattern="[1-9]{1}[0-9]{9}"/>
                        </td>
                    </tr>
                </div>
                <br>
                <div>
                    <tr><td></td><td>
                            <input class="kepybutton" type="submit" id="submit" class="form-control" value="Book Appointment">
                    </tr></td><td></td>
                </div>
