<%-- 
    ...
    Created on : Jan 21, 2018, 9:03:12 PM
    Author     : sonav
--%>
...
<html>
    ...
    <body onload="CheckNotification()">
                                    ...
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item dropdown">
                                            ...
                                            <div class="dropdown-content">
                                                ...
                                                <a href="updatepassword.jsp menu__item--current" class="menu__link sub-menu">Update Password</a>
                                            </div>
                                        </li>
        ...
        <br><br><br>
        <div>
            <form class="form-horizontal" action="update_password">
                <div class="form-group">
                    <label class="control-label col-sm-5" for="pwd">Old Password:</label>
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required id="pwd" placeholder="Enter old password" name="oldpass">
                    </div>
                </div><br>
                <div class="form-group">
                    <label class="control-label col-sm-5" for="pwd">New Password:</label>
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required pattern="^.{8,15}$" id="password" placeholder="Enter New password" name="password">
                    </div>
                </div><br>
                <div class="form-group">
                    <label class="control-label col-sm-5" for="pwd">Confirm Password:</label>
                    <div class="col-sm-3">          
                        <input type="password" class="form-control" required pattern="^.{8,15}$" id="confirmpass" placeholder="Enter Confirm password" name="newpass">
                    </div>
                </div><br>
                <div class="form-group">        
                    <div class="col-sm-offset-1 col-sm-10">
                        <div class="col-sm-offset-5 col-sm-2">
                            <input onclick="return ValidatePass()" style="background-color: #4CAF50;border: none;color: white;padding: 1px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 20px 2px;cursor: pointer;" type="submit" id="submit" class="form-control" value="Update">
                        </div>
                    </div><br>
                </div>
            </form>
